...
\title{Ứng dụng học sâu trong hệ gợi ý} % Article title, use manual lines breaks (\\) to beautify the layout
...
Hệ gợi ý là một thuật toán trí tuệ nhân tạo (AI), thường liên quan đến học máy, sử dụng Dữ liệu lớn để đề xuất hoặc gợi ý thêm các sản phẩm cho người tiêu dùng. Những gợi ý này có thể dựa trên các tiêu chí khác nhau, bao gồm lịch sử mua hàng, lịch sử tìm kiếm, thông tin nhân khẩu học và các yếu tố khác. Hệ thống gợi ý rất hữu ích vì chúng giúp người dùng khám phá các sản phẩm và dịch vụ mà họ có thể không tìm thấy nếu không.

Hệ gợi ý được đào tạo để hiểu sở thích, các quyết định trước đó và đặc điểm của người dùng và sản phẩm bằng cách sử dụng dữ liệu thu thập được về cách tương tác của họ. Những dữ liệu này bao gồm hiển thị, nhấp chuột, thích và mua hàng. Do khả năng dự đoán sở thích và mong muốn của người tiêu dùng ở mức độ cá nhân hóa cao, hệ thống gợi ý được các nhà cung cấp nội dung và sản phẩm ưa chuộng. Chúng có thể hướng người tiêu dùng đến bất kỳ sản phẩm hoặc dịch vụ nào mà họ quan tâm, từ sách đến video, từ lớp học sức khỏe đến quần áo.

Mục tiêu của báo cáo này là giới thiệu về ứng dụng của mô hình SASRec cho bài toán hệ gợi ý. 
\begin{equation}
